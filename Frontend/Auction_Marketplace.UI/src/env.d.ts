...
interface ImportMetaEnv {
    ...
    readonly VITE_GET_REVIEWS_ENDPOINT: string
    readonly VITE_CREATE_REVIEW_ENDPOINT: string
    readonly VITE_AVERAGE_RATING_FOR_AUCTION_ENDPOINT: string
    readonly VITE_SEND_EMAIL_TO_THE_WINNER_ENDPOINT: string
    readonly VITE_CHECK_AUCTIONS_PAYMENT_STATUS_ENDPOINT: string
}
